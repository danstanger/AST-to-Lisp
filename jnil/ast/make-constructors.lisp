...
(make-constructor compilation-unit unit-package imports types node-parent node-type )
...
(make-constructor primitive-type node-parent primitive-type-code type-binding)
...
(make-constructor type-declaration node-parent node-type declaration-name fields methods superinterfaces declaration-superclass types)
