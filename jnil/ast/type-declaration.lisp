...
(def-java-class (type-declaration "org.eclipse.jdt.core.dom.TypeDeclaration")
  ...
  () () (fields methods types superinterfaces))

;;; Java methods
(def-java-method (declaration-name "getName1") (type-declaration))
...
(def-java-method (declaration-binding "resolveBinding1") (type-declaration))
...
(trace declaration-fields declaration-methods declaration-types declaration-superinterfaces)
