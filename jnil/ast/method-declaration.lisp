...
(def-java-class (method-declaration "org.eclipse.jdt.core.dom.MethodDeclaration") (body-declaration)
  () () (name parameters thrownexceptions))

;;; Java methods
(def-java-method (declaration-body "getBody3") (method-declaration))

(def-java-method (declaration-name "getName3") (method-declaration))
